...
def run_test_better_draw_circles():
    ...
    # Test 2:
    expected = 2
    answer = better_draw_circles(2)
    # Test 3:
    expected = 1
    answer = better_draw_circles(1)
...
def run_test_even_better_draw_circles():
    # Test 1:
    even_better_draw_circles(12, 12, rg.Point(150, 150), "blue")
    # Test 2:
    even_better_draw_circles(2, 5, rg.Point(200, 200), "red")
    # Test 3:
    even_better_draw_circles(5, 5, rg.Point(175, 300), 'green')

def even_better_draw_circles(rad, cc, centercc, outlinecolor):
    window = rg.RoseWindow(400, 400)
    for k in range(cc):
        circle = rg.Circle(centercc, rad * k)
